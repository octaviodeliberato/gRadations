...
The goal of gRadations is to The purpose of gRadations is to allow the representation of size distributions by means of curve fitting.
...
```{r example, out.width="100%", warning=FALSE}
library(gRadations)
